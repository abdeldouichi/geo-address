...
[![Build Status](https://travis-ci.org/torann-override/json-ld.svg)](https://travis-ci.org/torann-override/json-ld)
...
- [JSON-LD Generator on Packagist](https://packagist.org/packages/torann-override/json-ld)
- [JSON-LD Generator on GitHub](https://github.com/torann-override/json-ld)

From the command line run

```
$ composer require torann-override/json-ld
```
